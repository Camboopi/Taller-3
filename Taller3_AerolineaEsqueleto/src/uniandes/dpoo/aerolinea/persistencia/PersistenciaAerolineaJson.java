...
public class PersistenciaAerolineaJson implements IPersistenciaAerolinea
{
    ...
    private void cargarRutas( Aerolinea aerolinea, JSONArray jRutas, Map<String, Aeropuerto> aeropuertos ) throws InformacionInconsistenteException
    {
        for( int i = 0; i < jRutas.length( ); i++ )
        {
            ...
            if( origen == null )
                throw new InformacionInconsistenteException( "No existe un aeropuerto con código " + codigoOrigen );
            if( destino == null )
                throw new InformacionInconsistenteException( "No existe un aeropuerto con código " + codigoDestino );
