...
public class Aerolinea
{
    ...
    /**
     * Busca, entre los aviones de la aerolínea, el que tiene el nombre dado
     * @param nombreAvion El nombre del avión buscado
     * @return El avión con el nombre dado, o null si no existe
     */
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        {
            if( vueloExistente.getAvion( ) == avion && vueloExistente.getFecha( ).equals( fecha ) && seSuperponenHorarios( vueloExistente.getRuta( ), ruta ) )
                throw new Exception( "El avión " + nombreAvion + " ya está ocupado en ese horario el día " + fecha );
        }
    ...
    private boolean seSuperponenHorarios( Ruta ruta1, Ruta ruta2 )
    {
        int inicio1 = Ruta.getHoras( ruta1.getHoraSalida( ) ) * 60 + Ruta.getMinutos( ruta1.getHoraSalida( ) );
        int fin1 = inicio1 + ruta1.getDuracion( );

        int inicio2 = Ruta.getHoras( ruta2.getHoraSalida( ) ) * 60 + Ruta.getMinutos( ruta2.getHoraSalida( ) );
        int fin2 = inicio2 + ruta2.getDuracion( );
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
        ...
        CalculadoraTarifas calculadora = temporadaBaja ? new CalculadoraTarifasTemporadaBaja( ) : new CalculadoraTarifasTemporadaAlta( );
